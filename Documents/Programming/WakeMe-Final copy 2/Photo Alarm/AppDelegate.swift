...
//  Alarm++
//
//  Created by Kashish Goel on 2015-08-28.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupAudioPlayerWithFile(file:NSString, type:NSString) -> AVAudioPlayer  {
        ...
        do {
            try audioPlayer = AVAudioPlayer(contentsOfURL: url)} catch {}
...
//        }
        if(  NSUserDefaults.standardUserDefaults().boolForKey("loaded") == false){
            NSUserDefaults.standardUserDefaults().setBool(false, forKey: "loaded")}
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "KashishGoel.Alarm__" in the application's documents Application Support directory.
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("TaskModel.sqlite")
